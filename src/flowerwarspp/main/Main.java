...
public class Main {
	...
	static void quitWithUsage() {
		...
		System.out.println("flowerwarspp.main.Main (-offer <Spielertyp> -name <Name> [-offerUrl <URL>] [-port <Port>]" +
				" | -size <Spielfeldgröße> -red <Spielertyp> [-redUrl <URL>] -blue <Spielertyp> [-blueUrl <URL>])" +
	...
	/**
	 * Einstiegspunkt der ausführbaren Klasse. Falls keine Kommandozeilenargumente übergeben werden, wird das Startmenü
	 * geöffnet, in welchem die Parameter von Hand in einer GUI gesetzt werden können.
	 *
	...
	/**
	 * Diese Methode initialisiert ein neues Spiel. Dabei werden die nötigen Instanzvariablen und Einstellungen
	 * gesetzt.
	 */
	...
	private static void start() {
		...
		try {
			...
			Log.log(LogLevel.ERROR, LogModule.MAIN, "Thread interrupted while waiting between moves.");
	 ...
	 * eines Spiels.
	 *
	 * @throws Exception        Falls während der Initialisierung der Spieler oder während des Spielverlaufs Fehler
	 *                          auftreten.
	 ...
	 * wurde.
	 *
	 * @throws Exception            Falls während des Ladens des Spielstands oder der Initialisierung des Spiels Fehler
	 *                              auftreten.
	 * @throws InterruptedException Falls während des Warten zwischen Spielzügen beim Replay der Thread unterbrochen
	 *                              wird.
	 * @throws LoadException        Falls beim Laden des Spielstands aus der Datei ein Fehler aufgetreten ist.
	 * @throws NetworkException     Falls an der gegebenen URL kein entfernter Spieler gefunden werden konnte.
	 */
	 ...
	 *
	 * @throws Exception        Falls während der Initialisierung der Spieler oder des Spielbretts Fehler aufgetreten
	 *                          sind.
	 * @throws NetworkException Falls an der gegebenen URL kein entfernter Spieler gefunden werden konnte.
	 */
	...
	/**
	 * Startet und verwaltet die Main-Loop. In jeder Iteration wird ein Zug vom aktuellen Spieler angefordert, dieser
	 ...
	 * @throws InterruptedException Falls während des Wartens zwischen Spielzügen der Thread unterbrochen worden ist.
	 */
