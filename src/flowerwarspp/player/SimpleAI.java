...
/**
 * Implementiert die abstrakte Klasse {@link AbstractPlayer} mit einer simplen KI. Diese KI bedient
 * sich einer limitierten Bewertungsstrategie zur Auswahl eines Zuges und gibt diesen auf
 * Anforderung zurück.
 */
public class SimpleAI extends AbstractAI {
	...
	/**
	 * Methode zur Berechnung des Scores eines gegebenen Zuges nach der gegebenen simplen Strategie
	 * der Projektbeschreibung. Wir werden diese Methode in Implementationen verbesserter KIs
	...
	protected int getMoveScore(Move move) {
		...
		/*
		 * Falls die beiden zu setzenden Blumen nebeneinander liegen, soll der Score verdoppelt
		 * werden.
		 * So werden Züge mit einzeln gesetzten Blumen immer nur dann gemacht, wenn es nicht
		 * anders geht.
		 */
