...
/**
 * Klasse, die dreieckige Polygone auf dem Zeichenbrett zeichnet. Objekte dieser Klasse
 * repräsentieren {@link Flower}s auf dem Spielbrett. Sie bestehen aus einer Spitze ("top") und zwei
 * weiteren Ecken ("left", "right").
 * <p>
 * Die Spitze ist die Ecke des Dreiecks, die gegenüber der Seite liegt, die parallel zur x-Achse des
 * Zeichenbretts verläuft.
 * <p>
 * Die linke Ecke ist immer die Ecke, die von der Spitze aus in Richtung des Ursprungs der x-Achse
 * des Zeichenbretts liegt.
 * <p>
 * Die rechte Ecke ist immer die Ecke, die von der Spitze aus auf der gegenüberliegenden Seite zur
 * linken Ecke liegt (d.h. in Richtung Unendlich der x-Achse des Zeichenbretts).
 */
public class Triangle extends BoardPolygon {
	 ...
	 *
	 * @return Eine {@link Flower}, die an der Stelle liegt, welche dieses {@link Triangle}
	 * repräsentiert.
	 */
