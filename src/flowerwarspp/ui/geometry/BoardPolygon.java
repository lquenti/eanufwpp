...
/**
 * Handhabt die Umrechnung von {@link flowerwarspp.preset.Board}-Koordinaten nach Swing-Koordinaten
 * für die Darstellung von {@link flowerwarspp.preset.Flower}s oder {@link
 * flowerwarspp.preset.Ditch}es.
 */
public abstract class BoardPolygon extends Polygon {
	...
	/**
	 * Zeichnet das {@link Polygon}, indem es dieses Objekt mit der {@link BoardPolygon#fillColor}
	 * füllt und es mit der {@link BoardPolygon#borderColor} umrandet.
	 *
	 * @param graphics
	 ...
	 *
	 * @return Die Farbe, mit der der Umriss dieses {@link Polygon} gezeichnet werden soll.
	 */
	 ...
	 *
	 * @return Die Farbe, mit dieses {@link Polygon} gefüllt werden soll.
	 */
	...
	/**
	 * Berechnet die {@link Point}s dieses Polygons relativ zum Koordinatensystem des Spielbretts.
	 *
	 ...
	 *
	 * @return Der berechnete Punkt, der an der Stelle liegt, an der der Punkt liegen soll.
	 */
